...
// dynamic greeting functions
  getLocation() {
    ...
    setTimeout(() => {
      ...
      const weatherAPI = `https://api.darksky.net/forecast/a407aac352fe8c5bc2d9253d6274dbc5/${this.state.currentPosition.lat},${this.state.currentPosition.lng}`;
// Testing different weather service
